...
| --------- | --------------- | ------------ | --------- |
| dc1-leafpair1 | Vlan4094 | 10.4.255.254 | Port-Channel551 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | KubernetesServer1_NIC2 | *trunk | *100,300,301,302 | *100 | *- | 1 |
| Ethernet2 | KubernetesServer2_NIC2 | *trunk | *100,300,301,302 | *100 | *- | 2 |
| Ethernet46 |  ISP2_NIC1 | access | 20 | - | - | - |
| Ethernet47 | FW01-Outside_NIC2 | *trunk | *10,20 | *- | *- | 47 |
| Ethernet48 | FW01-Inside_NIC2 | *trunk | *100,200,201,202,300,301,302 | *- | *- | 48 |
| Ethernet55/1 | MLAG_PEER_dc1-leaf1_Ethernet55/1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 551 |
| Ethernet56/1 | MLAG_PEER_dc1-leaf1_Ethernet56/1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 551 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_LINK_TO_DC1-SPINE1_Ethernet2/1 | routed | - | 10.2.0.1/31 | default | 9100 | False | - | - |
| Ethernet50/1 | P2P_LINK_TO_DC1-SPINE2_Ethernet2/1 | routed | - | 10.2.0.3/31 | default | 9100 | False | - | - |
...
!
interface Ethernet1
   description KubernetesServer1_NIC2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description KubernetesServer2_NIC2
   no shutdown
...
interface Ethernet47
   description FW01-Outside_NIC2
   no shutdown
   channel-group 47 mode active
!
interface Ethernet48
   description FW01-Inside_NIC2
   no shutdown
...
interface Ethernet55/1
   description MLAG_PEER_dc1-leaf1_Ethernet55/1
   no shutdown
   channel-group 551 mode active
!
interface Ethernet56/1
   description MLAG_PEER_dc1-leaf1_Ethernet56/1
   no shutdown
   channel-group 551 mode active
```
...
| Port-Channel551 | MLAG_PEER_dc1-leaf1_Po551 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel551
   description MLAG_PEER_dc1-leaf1_Po551
   no shutdown
   switchport
   switchport mode trunk
...
| Vlan3000 |  InbandMgmt  |  10.3.255.255/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3001 |  Kubernetes  |  10.3.255.255/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3002 |  Proxmox  |  10.3.255.255/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.3.255.255/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.4.255.255/31  |  -  |  -  |  -  |  -  |  -  |
...
| 10.2.0.0 | 65000 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.2.0.2 | 65000 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.3.255.254 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| 10.3.255.254 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | InbandMgmt | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.3.255.254 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Kubernetes | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.3.255.254 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Proxmox | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.1.0.3:10010 | 65000:10010 | - | - | learned |
| 20 | 10.1.0.3:10020 | 65000:10020 | - | - | learned |
| 100 | 10.1.0.3:10100 | 65000:10100 | - | - | learned |
| 200 | 10.1.0.3:10200 | 65000:10200 | - | - | learned |
| 201 | 10.1.0.3:10201 | 65000:10201 | - | - | learned |
| 202 | 10.1.0.3:10202 | 65000:10202 | - | - | learned |
| 300 | 10.1.0.3:10300 | 65000:10300 | - | - | learned |
| 301 | 10.1.0.3:10301 | 65000:10301 | - | - | learned |
| 302 | 10.1.0.3:10302 | 65000:10302 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| InbandMgmt | 10.1.0.3:1 | connected<br>static |
| Kubernetes | 10.1.0.3:2 | connected<br>static |
| Proxmox | 10.1.0.3:3 | connected<br>static |
...
router bgp 65001
   ...
   neighbor 10.2.0.0 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.2.0.0 remote-as 65000
   neighbor 10.2.0.0 description dc1-spine1_Ethernet2/1
   neighbor 10.2.0.2 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.2.0.2 remote-as 65000
   neighbor 10.2.0.2 description dc1-spine2_Ethernet2/1
   neighbor 10.3.255.254 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.3.255.254 description dc1-leaf1
