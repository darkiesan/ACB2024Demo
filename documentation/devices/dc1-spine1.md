...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1/1 | P2P_LINK_TO_DC1-LEAF1_Ethernet49/1 | routed | - | 10.0.1.252/31 | default | 9100 | False | - | - |
| Ethernet2/1 | P2P_LINK_TO_DC1-LEAF2_Ethernet49/1 | routed | - | 10.0.2.0/31 | default | 9100 | False | - | - |
| Ethernet3/1 | P2P_LINK_TO_DC1-LEAF3_Ethernet49/1 | routed | - | 10.0.2.4/31 | default | 9100 | False | - | - |
| Ethernet4/1 | P2P_LINK_TO_DC1-LEAF4_Ethernet49/1 | routed | - | 10.0.2.8/31 | default | 9100 | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.0.1.0/32 |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.0.1.253 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.0.2.1 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.0.2.5 | 65002 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.0.2.9 | 65002 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
router bgp 65000
   ...
   neighbor 10.0.1.253 remote-as 65001
   neighbor 10.0.1.253 description dc1-leaf1_Ethernet49/1
   neighbor 10.0.2.1 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.0.2.1 remote-as 65001
   neighbor 10.0.2.1 description dc1-leaf2_Ethernet49/1
   neighbor 10.0.2.5 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.0.2.5 remote-as 65002
   neighbor 10.0.2.5 description dc1-leaf3_Ethernet49/1
   neighbor 10.0.2.9 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.0.2.9 remote-as 65002
   neighbor 10.0.2.9 description dc1-leaf4_Ethernet49/1
