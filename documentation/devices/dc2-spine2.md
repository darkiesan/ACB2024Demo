...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1/1 | P2P_dc2-leaf1_Ethernet50/1 | - | 10.0.6.254/31 | default | 9100 | False | - | - |
| Ethernet2/1 | P2P_dc2-leaf2_Ethernet50/1 | - | 10.0.7.2/31 | default | 9100 | False | - | - |
| Ethernet3/1 | P2P_dc2-leaf3_Ethernet50/1 | - | 10.0.7.6/31 | default | 9100 | False | - | - |
| Ethernet4/1 | P2P_dc2-leaf4_Ethernet50/1 | - | 10.0.7.10/31 | default | 9100 | False | - | - |
...
interface Ethernet1/1
   description P2P_dc2-leaf1_Ethernet50/1
   no shutdown
   mtu 9100
   no switchport
   ip address 10.0.6.254/31
!
interface Ethernet2/1
   description P2P_dc2-leaf2_Ethernet50/1
   no shutdown
   mtu 9100
   no switchport
   ip address 10.0.7.2/31
!
interface Ethernet3/1
   description P2P_dc2-leaf3_Ethernet50/1
   no shutdown
   mtu 9100
   no switchport
   ip address 10.0.7.6/31
!
interface Ethernet4/1
   description P2P_dc2-leaf4_Ethernet50/1
   no shutdown
   mtu 9100
   no switchport
   ip address 10.0.7.10/31
```
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.0.6.1/32 |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.0.6.255 | 65101 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.0.7.3 | 65101 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.0.7.7 | 65102 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.0.7.11 | 65102 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
router bgp 65100
   ...
   neighbor 10.0.6.255 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.0.6.255 remote-as 65101
   neighbor 10.0.6.255 description dc2-leaf1_Ethernet50/1
   neighbor 10.0.7.3 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.0.7.3 remote-as 65101
   neighbor 10.0.7.3 description dc2-leaf2_Ethernet50/1
   neighbor 10.0.7.7 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.0.7.7 remote-as 65102
   neighbor 10.0.7.7 description dc2-leaf3_Ethernet50/1
   neighbor 10.0.7.11 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.0.7.11 remote-as 65102
   neighbor 10.0.7.11 description dc2-leaf4_Ethernet50/1
