...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | SERVER_KubernetesServer3_NIC1 | *trunk | *100,300-302 | *100 | *- | 1 |
| Ethernet2 | SERVER_KubernetesServer4_NIC1 | *trunk | *100,300-302 | *100 | *- | 2 |
| Ethernet45 | SERVER_ISP1_NIC1 | access | 10 | - | - | - |
| Ethernet47 | SERVER_FW02-Outside_NIC1 | *trunk | *10,20 | *- | *- | 47 |
| Ethernet48 | SERVER_FW02-Inside_NIC1 | *trunk | *100,200-202,300-302 | *- | *- | 48 |
| Ethernet55/1 | MLAG_dc2-leaf2_Ethernet55/1 | *trunk | *- | *- | *MLAG | 551 |
| Ethernet56/1 | MLAG_dc2-leaf2_Ethernet56/1 | *trunk | *- | *- | *MLAG | 551 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_dc2-spine1_Ethernet1/1 | - | 10.0.6.253/31 | default | 9100 | False | - | - |
| Ethernet50/1 | P2P_dc2-spine2_Ethernet1/1 | - | 10.0.6.255/31 | default | 9100 | False | - | - |
| Ethernet51/1 | P2P_dc1-leaf1_Ethernet51/1 | - | 10.0.11.1/31 | default | 9100 | False | - | - |
| Ethernet52/1 | P2P_dc1-leaf2_Ethernet51/1 | - | 10.0.11.5/31 | default | 9100 | False | - | - |
...
!
interface Ethernet1
   description SERVER_KubernetesServer3_NIC1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description SERVER_KubernetesServer4_NIC1
   no shutdown
...
interface Ethernet47
   description SERVER_FW02-Outside_NIC1
   no shutdown
   channel-group 47 mode active
!
interface Ethernet48
   description SERVER_FW02-Inside_NIC1
   no shutdown
   channel-group 48 mode active
!
interface Ethernet49/1
   description P2P_dc2-spine1_Ethernet1/1
   no shutdown
   mtu 9100
   no switchport
...
interface Ethernet51/1
   description P2P_dc1-leaf1_Ethernet51/1
   no shutdown
   mtu 9100
   no switchport
...
interface Ethernet52/1
   description P2P_dc1-leaf2_Ethernet51/1
   no shutdown
   mtu 9100
   no switchport
...
interface Ethernet55/1
   description MLAG_dc2-leaf2_Ethernet55/1
   no shutdown
   channel-group 551 mode active
!
interface Ethernet56/1
   description MLAG_dc2-leaf2_Ethernet56/1
   no shutdown
   channel-group 551 mode active
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | KubernetesServer3 | trunk | 100,300-302 | 100 | - | - | - | 1 | - |
| Port-Channel2 | KubernetesServer4 | trunk | 100,300-302 | 100 | - | - | - | 2 | - |
| Port-Channel47 | FW02-Outside | trunk | 10,20 | - | - | - | - | 47 | - |
| Port-Channel48 | FW01-Inside | trunk | 100,200-202,300-302 | - | - | - | - | 48 | - |
| Port-Channel551 | MLAG_dc2-leaf2_Port-Channel551 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel551
   description MLAG_dc2-leaf2_Port-Channel551
   no shutdown
   switchport mode trunk
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.0.6.2/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 10.0.8.2/32 |
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ------ | ------- |
| Vlan100 |  InbandMgmt  |  10.10.0.9/24  |  -  |  -  |  -  |  -  |
...
router bgp 65101
   ...
   neighbor 10.0.6.4 description dc2-leaf3_Loopback0
   neighbor 10.0.6.5 peer group EVPN-OVERLAY-PEERS
   neighbor 10.0.6.5 remote-as 65102
   neighbor 10.0.6.5 description dc2-leaf4_Loopback0
   ...
   neighbor 10.0.8.255 description dc2-leaf2_Vlan4093
   ...
   vrf InbandMgmt
      ...
      update wait-install
      neighbor 10.0.8.255 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.0.8.255 description dc2-leaf2_Vlan3000
   ...
   vrf Kubernetes
      ...
      update wait-install
      neighbor 10.0.8.255 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.0.8.255 description dc2-leaf2_Vlan3001
      redistribute connected route-map RM-CONN-2-BGP-VRFS
      redistribute static
   !
   vrf Proxmox
      ...
      update wait-install
      neighbor 10.0.8.255 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.0.8.255 description dc2-leaf2_Vlan3002
      redistribute connected route-map RM-CONN-2-BGP-VRFS
      redistribute static
```
