...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | KubernetesServer3_NIC1 | *trunk | *100,300,301,302 | *100 | *- | 1 |
| Ethernet2 | KubernetesServer4_NIC1 | *trunk | *100,300,301,302 | *100 | *- | 2 |
| Ethernet45 |  ISP1_NIC1 | access | 10 | - | - | - |
| Ethernet47 | FW02-Outside_NIC1 | *trunk | *10,20 | *- | *- | 47 |
| Ethernet48 | FW02-Inside_NIC1 | *trunk | *100,200,201,202,300,301,302 | *- | *- | 48 |
| Ethernet55/1 | MLAG_PEER_dc2-leaf2_Ethernet55/1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 551 |
| Ethernet56/1 | MLAG_PEER_dc2-leaf2_Ethernet56/1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 551 |
...
!
interface Ethernet1
   description KubernetesServer3_NIC1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description KubernetesServer4_NIC1
   no shutdown
...
interface Ethernet47
   description FW02-Outside_NIC1
   no shutdown
   channel-group 47 mode active
!
interface Ethernet48
   description FW02-Inside_NIC1
   no shutdown
...
interface Ethernet56/1
   description MLAG_PEER_dc2-leaf2_Ethernet56/1
   no shutdown
   channel-group 551 mode active
```
...
| Port-Channel551 | MLAG_PEER_dc2-leaf2_Po551 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel551
   description MLAG_PEER_dc2-leaf2_Po551
   no shutdown
   switchport
   switchport mode trunk
