...
| --------- | --------------- | ------------ | --------- |
| dc2-leafpair2 | Vlan4094 | 10.10.0.2 | Port-Channel531 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet53/1 | MLAG_PEER_dc2-leaf3_Ethernet53/1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 531 |
| Ethernet54/1 | MLAG_PEER_dc2-leaf3_Ethernet54/1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 531 |
...
interface Ethernet53/1
   description MLAG_PEER_dc2-leaf3_Ethernet53/1
   no shutdown
   channel-group 531 mode active
!
interface Ethernet54/1
   description MLAG_PEER_dc2-leaf3_Ethernet54/1
   no shutdown
   channel-group 531 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel531 | MLAG_PEER_dc2-leaf3_Po531 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel531
   description MLAG_PEER_dc2-leaf3_Po531
   no shutdown
   switchport
...
| Vlan3000 |  VRF_A  |  10.9.0.3/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3001 |  VRF_B  |  10.9.0.3/31  |  -  |  -  |  -  |  -  |  -  |
...
| 10.9.0.2 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF_A | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.9.0.2 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF_B | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| 101 | 10.6.0.5:10101 | 65000:10101 | - | - | learned |
...
| --- | ------------------- | ------------ |
| VRF_A | 10.6.0.5:1 | connected |
| VRF_B | 10.6.0.5:2 | connected |
