...
| --------- | --------------- | ------------ | --------- |
| dc2-leafpair2 | Vlan4094 | 10.10.0.2 | Port-Channel551 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet55/1 | MLAG_PEER_dc2-leaf3_Ethernet55/1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 551 |
| Ethernet56/1 | MLAG_PEER_dc2-leaf3_Ethernet56/1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 551 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_LINK_TO_DC2-SPINE1_Ethernet4/1 | routed | - | 10.7.0.9/31 | default | 9100 | False | - | - |
| Ethernet50/1 | P2P_LINK_TO_DC2-SPINE2_Ethernet4/1 | routed | - | 10.7.0.11/31 | default | 9100 | False | - | - |
...
interface Ethernet49/1
   description P2P_LINK_TO_DC2-SPINE1_Ethernet4/1
   no shutdown
   mtu 9100
   no switchport
   ip address 10.7.0.9/31
!
interface Ethernet50/1
   description P2P_LINK_TO_DC2-SPINE2_Ethernet4/1
   no shutdown
   mtu 9100
   no switchport
   ip address 10.7.0.11/31
!
interface Ethernet55/1
   description MLAG_PEER_dc2-leaf3_Ethernet55/1
   no shutdown
   channel-group 551 mode active
!
interface Ethernet56/1
   description MLAG_PEER_dc2-leaf3_Ethernet56/1
   no shutdown
   channel-group 551 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel551 | MLAG_PEER_dc2-leaf3_Po551 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel551
   description MLAG_PEER_dc2-leaf3_Po551
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.6.0.5/32 |
...
| Vlan3000 |  InbandMgmt  |  10.9.0.3/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3001 |  Kubernetes  |  10.9.0.3/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3002 |  Proxmox  |  10.9.0.3/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.9.0.3/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.10.0.3/31  |  -  |  -  |  -  |  -  |  -  |
...
| 10.7.0.8 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.7.0.10 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.9.0.2 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.9.0.2 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | InbandMgmt | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.9.0.2 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Kubernetes | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.9.0.2 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Proxmox | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.6.0.5:10010 | 65000:10010 | - | - | learned |
| 20 | 10.6.0.5:10020 | 65000:10020 | - | - | learned |
| 100 | 10.6.0.5:10100 | 65000:10100 | - | - | learned |
| 200 | 10.6.0.5:10200 | 65000:10200 | - | - | learned |
| 201 | 10.6.0.5:10201 | 65000:10201 | - | - | learned |
| 202 | 10.6.0.5:10202 | 65000:10202 | - | - | learned |
| 300 | 10.6.0.5:10300 | 65000:10300 | - | - | learned |
| 301 | 10.6.0.5:10301 | 65000:10301 | - | - | learned |
| 302 | 10.6.0.5:10302 | 65000:10302 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| InbandMgmt | 10.6.0.5:1 | connected |
| Kubernetes | 10.6.0.5:2 | connected |
| Proxmox | 10.6.0.5:3 | connected |
...
router bgp 65102
   ...
   neighbor 10.7.0.8 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.7.0.8 remote-as 65100
   neighbor 10.7.0.8 description dc2-spine1_Ethernet4/1
   neighbor 10.7.0.10 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.7.0.10 remote-as 65100
   neighbor 10.7.0.10 description dc2-spine2_Ethernet4/1
   neighbor 10.9.0.2 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.9.0.2 description dc2-leaf3
