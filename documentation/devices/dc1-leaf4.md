...
| --------- | --------------- | ------------ | --------- |
| dc1-leafpair2 | Vlan4094 | 10.0.5.2 | Port-Channel551 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet55/1 | MLAG_dc1-leaf3_Ethernet55/1 | *trunk | *- | *- | *MLAG | 551 |
| Ethernet56/1 | MLAG_dc1-leaf3_Ethernet56/1 | *trunk | *- | *- | *MLAG | 551 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_dc1-spine1_Ethernet4/1 | - | 10.0.2.9/31 | default | 9100 | False | - | - |
| Ethernet50/1 | P2P_dc1-spine2_Ethernet4/1 | - | 10.0.2.11/31 | default | 9100 | False | - | - |
...
interface Ethernet55/1
   description MLAG_dc1-leaf3_Ethernet55/1
   no shutdown
   channel-group 551 mode active
!
interface Ethernet56/1
   description MLAG_dc1-leaf3_Ethernet56/1
   no shutdown
   channel-group 551 mode active
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel551 | MLAG_dc1-leaf3_Port-Channel551 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel551
   description MLAG_dc1-leaf3_Port-Channel551
   no shutdown
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.0.1.5/32 |
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ------ | ------- |
| Vlan100 |  InbandMgmt  |  10.10.0.6/24  |  -  |  -  |  -  |  -  |
...
| Vlan3000 |  InbandMgmt  |  10.0.4.3/31  |  -  |  -  |  -  |  -  |
| Vlan3001 |  Kubernetes  |  10.0.4.3/31  |  -  |  -  |  -  |  -  |
| Vlan3002 |  Proxmox  |  10.0.4.3/31  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.0.4.3/31  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.0.5.3/31  |  -  |  -  |  -  |  -  |
...
| 10.0.2.8 | 65000 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.0.2.10 | 65000 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.0.4.2 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.0.4.2 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | InbandMgmt | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.0.4.2 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Kubernetes | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.0.4.2 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Proxmox | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.0.1.5:10010 | 65000:10010 | - | - | learned |
| 20 | 10.0.1.5:10020 | 65000:10020 | - | - | learned |
| 100 | 10.0.1.5:10100 | 65000:10100 | - | - | learned |
| 200 | 10.0.1.5:10200 | 65000:10200 | - | - | learned |
| 201 | 10.0.1.5:10201 | 65000:10201 | - | - | learned |
| 202 | 10.0.1.5:10202 | 65000:10202 | - | - | learned |
| 300 | 10.0.1.5:10300 | 65000:10300 | - | - | learned |
| 301 | 10.0.1.5:10301 | 65000:10301 | - | - | learned |
| 302 | 10.0.1.5:10302 | 65000:10302 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| InbandMgmt | 10.0.1.5:1 | connected |
| Kubernetes | 10.0.1.5:2 | connected |
| Proxmox | 10.0.1.5:3 | connected |
...
router bgp 65002
   ...
   neighbor 10.0.2.8 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.0.2.8 remote-as 65000
   neighbor 10.0.2.8 description dc1-spine1_Ethernet4/1
   neighbor 10.0.2.10 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.0.2.10 remote-as 65000
   neighbor 10.0.2.10 description dc1-spine2_Ethernet4/1
   neighbor 10.0.4.2 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.0.4.2 description dc1-leaf3_Vlan4093
   ...
   vrf InbandMgmt
      ...
      update wait-install
      neighbor 10.0.4.2 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.0.4.2 description dc1-leaf3_Vlan3000
   ...
   vrf Kubernetes
      ...
      update wait-install
      neighbor 10.0.4.2 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.0.4.2 description dc1-leaf3_Vlan3001
      redistribute connected route-map RM-CONN-2-BGP-VRFS
   !
   vrf Proxmox
      rd 10.0.1.5:3
      ...
      update wait-install
      neighbor 10.0.4.2 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.0.4.2 description dc1-leaf3_Vlan3002
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
